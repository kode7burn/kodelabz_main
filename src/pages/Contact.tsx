...
const Contact: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-xl mb-12 text-center">Get in touch with our team for any inquiries or support</p>
        ...
        <div>
          ...
          <form>
            ...
            <div className="mb-4">
              ...
              <input type="text" id="subject" className="w-full p-2 bg-gray-700 rounded" required />
            </div>
            <div className="mb-4">
              <label htmlFor="message" className="block mb-2">Message</label>
              <textarea id="message" rows={6} className="w-full p-2 bg-gray-700 rounded" required></textarea>
            </div>
